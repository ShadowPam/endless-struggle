...
export class Game extends Scene {
    ...
    create() {
        ...
        this.mcBar.width =
            this.game.config.initData.mcHp * (146 / this.game.config.initData.mcMaxHp);

        this.mcBarText = this.add
            .text(
                450,
                700,
                this.game.config.initData.mcHp + "/" + this.game.config.initData.mcMaxHp,
                {
                    fontFamily: "Marcellus",
                    fontSize: 16,
                    color: "#ffffff",
        ...
        this.enemyDamagePotential = this.add
            .text(
                1470,
                500,
                this.game.config.initData.enemyAttack -
                    Math.round(
                        this.game.config.initData.enemyAttack *
                            this.game.config.initData.enemyDamageSpread
                    ) +
                    " - " +
                    (this.game.config.initData.enemyAttack +
                        Math.round(
        ...
        this.enemyBar.width =
            this.game.config.initData.enemyHp * (146 / this.game.config.initData.enemyMaxHp);

        this.enemyBarText = this.add
            .text(
                1470,
                725,
                this.game.config.initData.enemyHp + "/" + this.game.config.initData.enemyMaxHp,
                {
                    fontFamily: "Marcellus",
                    fontSize: 16,
                    color: "#ffffff",
    ...
    showNewEnemy(props) {
        ...
        this.enemyDamagePotential.setText(
            props.enemyAttack -
                Math.round(props.enemyAttack * props.enemyDamageSpread) +
                " - " +
