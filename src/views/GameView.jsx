  ...
  return (
    <div>
      ...
      <div id="buttons">
        ...
        <button disabled={props.combatState!==0} className="button shieldbutton" onClick={ShieldACB}>SHIELD</button>
        <button disabled={props.combatState!==0} className="button dodgebutton" onClick={DodgeACB}>DODGE</button>
      </div>
    </div>
  );
}
